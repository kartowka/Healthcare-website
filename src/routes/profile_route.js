...
profile
    ...
    .get(user_controller.allowIfLoggedin, user_controller.grantAccess('readOwn','patient_profile'),user_controller.grantAccess('readOwn','doctor_profile'), user_controller.getUser,(req,res)=>{
